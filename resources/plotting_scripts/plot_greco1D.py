...
####
#### This script plots GRECO 1D selection plots
#### for the combined nutau paper. The variables
#### included in the paper includes
####
#### level 4: Tol, BDT
#### level 5: VICH, BDT
#### level 6: FillRatio, NCh
#### level 7: Normalized RMS
####
#### Command line:
####   python plot_greco1D.py --outdir <output folder>
####             (--fitnorm)
####
#### NOTE: These plots are made from Michael's
####       pickled files at lower levels with
####       an extension `.pckl`, located at
####       resources/pickled_data/greco/level3-7/.
...
####
####       At lower level, no fits was performed.
####       So, histograms are normalized between
####       data and total MC.
####
#########################################################
...
####
#########################################################
settings = {'level4_toi_eigenvalueratio'  : {'xranges':(   0, 0.325) ,
                                             'yranges':(1e-5, 1e-2)  ,
                                             'rranges':(0.0 ,  2.0)  ,
                                             'nbins'  :50            ,
                                             'hloc'   :1 , 'rloc': 8 ,
                                             'ncols'  :3 , 'cut':None},
            'level5_vetocausalhits'       : {'xranges':(0   , 20)    ,
                                             'yranges':(1e-5, 0.001) ,
                                             'rranges':(0   , 2)     ,
                                             'nbins'  :50            , 
                                             'hloc'   :1 , 'rloc': 9 ,
                                             'ncols'  :2 , 'cut':None},
            'level6_fillratio'            : {'xranges':(0  , 0.3)    ,
                                             'yranges':(1e-6, 1e-4)  ,
                                             'rranges':(0.5, 1.5)    ,
                                             'nbins'  :50            ,
                                             'hloc'   :1 , 'rloc': 9 ,
                                             'ncols'  :2 , 'cut':0.05},
            'level6_nchannel'             : {'xranges':(0   ,  50)   ,
                                             'yranges':(1e-6, 1e-4)  ,
                                             'rranges':(0.5, 1.5)    ,
                                             'nbins'  :50            , 
                                             'hloc'   :1 , 'rloc': 9 ,
                                             'ncols'  :2 , 'cut':8   },
            'level7_charge_rms_normalized': {'xranges':(   0,    1)  ,
                                             'yranges':(1e-6, 1e-4)  ,
                                             'rranges':(0.5, 1.5)    ,
                                             'nbins'  :50            ,
                                             'hloc'   :1 , 'rloc': 8 ,
                                             'ncols'  :2 , 'cut':0.85},
            'level4_bdtscore'             : {'xranges':(-0.6,  0.6)  ,
                                             'yranges':(1e-5, 1e-2)  ,
                                             'rranges':(0.0, 2.0)    ,
                                             'nbins'  :50            ,
                                             'hloc'   :1 , 'rloc':8  ,
                                             'ncols'  :3 , 'cut':0.04},
            'level5_bdtscore'             : {'xranges':(-0.4,  0.5)  ,
                                             'yranges':(1e-6, 1e-3)  ,
                                             'rranges':(0.0, 2.0)    ,
                                             'nbins'  :50            ,
                                             'hloc'   :1 , 'rloc':8  ,
...
def plot_variables (outdir, events, fitnorm=False):
    ...
    for variable in settings:
        ...
        if fitnorm:
            ...
            fitter.dtypes  = sorted (events[level].keys ())
